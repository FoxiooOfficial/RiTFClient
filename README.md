...
- RiTF (Client) is a lightweight Android app (requiring API 8+) written in JDK 7 and the raw Android SDK (without Android Studio) that sends unencrypted HTTP GET requests to the Host to retrieve data from specific tags (as on Booru-style sites).
